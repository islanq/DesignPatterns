...
namespace visitor { namespace infotype {
                    class Visitor {
public:

                      virtual ~Visitor() = default;
                      virtual auto Visit(class Primitive *,
                                           class Component *)->void = 0;
                      virtual auto Visit(class Composite *,
                                           Component *)->void       = 0;
                    };
...
public:
                      ...
                      virtual auto Accept(Visitor  & v,
                                          Component *c)->void override {
                        v.Visit(this, c);
                      }
                    };
...
public:
                      ...
                      virtual auto Visit(Primitive *,
                                         Component *)->void override { /* does
                                                                          not
                                                                          make
                                                                          sense
                                                                          */
                      ...
                      virtual auto Visit(Composite *node,
                                         Component *c)->void override {
                        node->Add(c);
                      }
                    };
                    ...
                    inline auto Run()->void
                    {
                      ...
                      // get the error -
                      //    no member function `Component::add(Component *)'
                      // defined
